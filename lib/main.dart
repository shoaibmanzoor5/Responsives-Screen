...
class MyHomePage extends StatelessWidget{
  ...
  final  textieldColor = Color(0xffF5F6FA);
          ...
          child: Padding(
            ...
            child: Column(
              ...
              SizedBox(height: 24.h,),
                ...
                SizedBox(height: 16.h,),
                getTextField(hint: "Coniform Password"),
                SizedBox(height: 16.h,),
                SizedBox(
                ...
                Row(
                  children: [
                    ...
                    Text("or sign up via ",style:TextStyle(
                        fontSize: 14.sp,fontWeight: FontWeight.w500,color: lightTextColor
                    )),
                    SizedBox(width: 16.w,),
                    Expanded(child: Divider()),
